<?php
    ...
    $app->get('/arduino/{id}',  function ($request, $response) {
        ...
        'mask'=>$arduino->getMask(), 'PinoDHT'=>$arduino->getPinoDHT(), 'PinoRele1'=>$arduino->getPinoRele1(), 'PinoRele2'=>$arduino->getPinoRele2(), 
        'PinoRele3'=>$arduino->getPinoRele3(), 'PinoRele4'=>$arduino->getPinoRele4(), 'PinoLDR'=>$arduino->getPinoLDR(), 'porta'=>$arduino->getPorta(), 'cod'=>$arduino->getCod());
